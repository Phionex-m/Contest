...
I made an application that print hello to anything the user want
...
I made an application which calculate the area of the circle and use method that take the first nine numbers after the decimal point
